...
- Deployment section is 10 to 15 minutes. It is a guided DIY: show the Hugging Face Spaces UI, walk through the file structure (`app.py`, `requirements.txt`, the saved model), and let them click Deploy. The product moment (a live URL the group can share with their parents) is the payoff for the week.
...
*CREED Aberdeen | RCCG Fountain of Love Aberdeen (Charity No: SC031493) | Aberdeen, Scotland*
